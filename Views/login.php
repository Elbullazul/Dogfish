...
<div class="container col-md-4">
  ...
  <form class="form-signin" id="form-signin" method="Post" action="<?= link_manager::get_link('authenticate'); ?>">
    ...
    <input type="text" id="inputUser" name="inputUser" class="form-control" placeholder="<?= label_manager::get_label('@UI08'); ?>" required="" autofocus="">
    <div class='spacer-1'></div>
    <label for="inputPassword" class="sr-only">
      <?= label_manager::get_label('@UI05'); ?>
    </label>
    <input type="password" id="inputPassword" name="inputPassword" class="form-control" placeholder="<?= label_manager::get_label('@UI05'); ?>" required="">
    <div class='spacer-1'></div>
    <div class="checkbox">
      <label>
